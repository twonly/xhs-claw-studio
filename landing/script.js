...
const I18N = {
  en: {
    meta: {
      ...
      privacy: {
        ...
        description: 'Privacy policy for HongShu Claw, explaining how the extension handles public XiaoHongShu data, browser storage, and cloud-backed workflows.',
        ogTitle: 'HongShu Claw Privacy Policy',
        ogDescription: 'Learn how HongShu Claw handles public page data, browser storage, and cloud-backed workflows.',
        locale: 'en_US'
      }
    },
    landing: {
      ...
      'install.note': 'This public build is installed through Chrome developer mode for now. It does not require manual account registration before first use.',
      ...
      'safety.card2.title': 'Browser-based workflow',
      'safety.card2.body': 'The extension uses browser storage and product-managed data flows to keep export and review usable across the workflow.',
      'safety.card3.title': 'Analysis layers on top',
      'safety.card3.body': 'AI analysis, dashboard import, and continuity features sit on top of the export flow instead of blocking it.',
      ...
      'faq.q4': 'Does it support AI analysis?',
      'faq.a4': 'Yes. The public build already supports AI reports and follow-up analysis if you configure your own compatible API key.',
      'faq.q5': 'How do I install the current public build?',
      'faq.a5': 'Use Chrome developer mode for now: download the repository or release ZIP, unzip it, then load the unpacked folder that contains manifest.json.',
    ...
    privacy: {
      ...
      'privacy.s1.body': 'This policy applies to the Chrome extension HongShu Claw and explains how it handles public XiaoHongShu data, local analysis data, and cloud-backed workflows.',
      ...
      'privacy.s2.i3': 'Relevant account, identity, sync, or generated-analysis data needed by the product\'s current workflow.',
      ...
      'privacy.s3.i3': 'We do not collect the user\'s XiaoHongShu account credentials as part of normal product usage.',
      ...
      'privacy.s4.i3': 'To support the product\'s current analysis, identity, continuity, and cloud-backed workflow where applicable.',
      'privacy.s4.i4': 'To improve export stability, resume behavior, and product usability.',
      'privacy.s5.title': '5. Local storage and cloud infrastructure',
      'privacy.s5.body1': 'HongShu Claw uses browser-local storage for local results, analysis state, and history records. Parts of the product workflow may also rely on cloud infrastructure for identity, persistence, or continuity.',
      'privacy.s5.body2': 'Cloud-backed behavior may vary by product version and current workflow design. Users should review the latest published policy and product UI before using cloud-related functionality.',
      ...
      'privacy.s7.body': 'Certain features may rely on third-party services such as AI APIs, cloud databases, analytics providers, or future payment and licensing systems. Necessary data exchange may occur as part of the product\'s current workflow and the features the user is using.',
      'privacy.s8.title': '8. Security and user control',
      'privacy.s8.body1': 'We try to follow reasonable technical measures such as minimum permissions, scoped data handling, and practical safeguards. However, no networked or cloud-based service can guarantee absolute security.',
      'privacy.s8.body2': 'Users can reduce their data footprint by uninstalling the extension, clearing browser storage, removing local data, or stopping use of features that rely on cloud or AI services.',
  ...
  zh: {
    meta: {
      ...
      privacy: {
        title: '红薯采集器隐私政策',
        description: '红薯采集器隐私政策，说明扩展如何处理小红书公开内容、浏览器存储和云端相关工作流。',
        ogTitle: '红薯采集器隐私政策',
        ogDescription: '了解红薯采集器如何处理公开页面数据、浏览器存储和云端相关工作流。',
        locale: 'zh_CN'
      }
    },
    landing: {
      ...
      'install.note': '当前公开版通过 Chrome 开发者模式安装，首次使用不要求手动注册账号。',
      'safety.card1.title': '面向公开页面工作',
      'safety.card1.body': '扩展围绕公开可见的小红书页面工作，不走账号凭证收集路线。',
      'safety.card2.title': '浏览器内工作流',
      'safety.card2.body': '扩展会使用浏览器存储和产品内数据流来支撑导出与复盘体验。',
      'safety.card3.title': '分析层建立在导出之上',
      'safety.card3.body': 'AI 分析、后台导入和连续性能力建立在导出链路之上，而不是先拦住主流程。',
      ...
      'faq.q4': '支持 AI 分析吗？',
      'faq.a4': '支持。当前公开版已经支持 AI 报告和追问式分析，只需要配置你自己的兼容 API Key。',
      'faq.q5': '当前公开版怎么安装？',
      'faq.a5': '目前通过 Chrome 开发者模式安装：下载仓库或 release ZIP，先解压，再加载包含 manifest.json 的文件夹。',
    ...
    privacy: {
      ...
      'privacy.s1.body': '本政策适用于 Chrome 扩展“红薯采集器”，用于说明产品如何处理小红书公开数据、本地分析数据以及云端相关工作流。',
      ...
      'privacy.s2.i3': '产品当前工作流所需的账号、身份、同步或分析生成相关数据。',
      'privacy.s3.title': '3. 默认不会收集的内容',
      'privacy.s3.i1': '不会收集或存储用户的小红书密码。',
      'privacy.s3.i2': '不会主动访问与本扩展功能无关的浏览内容。',
      'privacy.s3.i3': '不会在正常产品使用中收集用户的小红书账号密码。',
      'privacy.s4.title': '4. 数据如何使用',
      'privacy.s4.i1': '用于导出小红书公开笔记内容和互动数据。',
      'privacy.s4.i2': '用于生成本地看板、轻量分析、筛选结果和素材库索引。',
      'privacy.s4.i3': '用于支持产品当前涉及的分析、身份、连续性和云端工作流。',
      'privacy.s4.i4': '用于提升导出稳定性、续传体验和产品可用性。',
      'privacy.s5.title': '5. 本地存储与云基础设施',
      'privacy.s5.body1': '红薯采集器会使用浏览器本地存储保存本地结果、分析状态和历史记录。产品工作流中的部分环节也可能依赖云基础设施，以支持身份、持久化或连续性。',
      'privacy.s5.body2': '云端相关行为可能会随着产品版本和当前工作流设计而变化。使用相关功能前，请以最新政策页面和产品界面提示为准。',
      'privacy.s6.title': '6. AI 功能',
      'privacy.s6.body': '当用户主动使用 AI 报告或 AI 对话时，产品可能会将完成该任务所需的摘要数据发送给已配置的 AI 服务提供商。',
      'privacy.s7.title': '7. 第三方服务',
      'privacy.s7.body': '部分功能可能依赖第三方服务，例如 AI API、云数据库、分析服务或未来的支付与授权系统。产品当前工作流和用户正在使用的功能，可能会带来必要的数据交互。',
      'privacy.s8.title': '8. 安全与用户控制',
      'privacy.s8.body1': '我们会尽量采用最小权限、范围化数据处理和合理保护措施，但任何网络或云服务都无法保证绝对安全。',
      'privacy.s8.body2': '用户可以通过卸载扩展、清除浏览器存储、删除本地数据，或停止使用依赖云端或 AI 服务的功能来缩小数据范围。',
