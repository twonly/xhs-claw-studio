...
const DATA_STORE = {
  ...
  async saveBlogger(userId, nickname, avatar, profileUrl, notes, stats = null) {
    ...
    if (dupId) {
      ...
      stats = this._mergeBloggerStats(stats, oldData?.stats || null);
    ...
    const mergedStats = this._mergeBloggerStats(stats, existingBlogger?.stats || null);
  ...
  _mergeBloggerStats(primary = null, fallback = null) {
