...
const AI_CATALOG = {
  ...
  PROVIDERS: {
    deepseek: {
      ...
      tagline: '国内首选，价格低、响应快；新账号通常送额度。',
      recommended: 'first_choice',
      models: [
    ...
    openai: {
      ...
      tagline: '推理最强；需国外支付。适合写深度分析报告。',
      recommended: 'best_reasoning',
      models: [
    ...
    zhipu: {
      ...
      tagline: '国产自研，新账号 2000 万 token 免费额度。',
      recommended: null,
      models: [
    ...
    siliconflow: {
      ...
      tagline: '一个 Key 调用多种开源模型，新号送 14 元额度。',
      recommended: 'oss_friendly',
      models: [
    ...
    custom: {
      ...
      docsUrl: '',
      signupUrl: '',
      tagline: '任意 OpenAI 兼容端点都行（含本地 Ollama / 自建代理）。',
      recommended: null,
      models: [],
