...
<p align="center">
  <strong>把小红书从“手动翻、手动抄、手动比”变成可抓取、可分析、可沉淀的内容工作台。</strong>
</p>
...
对很多博主、操盘手和 MCN 来说，真正麻烦的不是“看内容”，而是：

- 爆款拆解靠手动截图、手动抄表，效率很低
- 想横向看竞品、看矩阵号，数据分散在多个页面里
- 抓完数据只停留在 Excel，后面很难继续复盘、筛选和沉淀
- 公开页数据和创作者后台数据是两套口径，分析链路经常断掉

`xhs-claw-studio` 就是为这个场景做的。

它把“小红书公开页抓取 + 导出 + 分析 + 素材沉淀 + 创作者后台导入”串成一条完整工作流，让你不用再在截图、表格、网页和零散笔记之间来回切。
...
核心不是“抓下来”，而是“抓下来之后还能继续用”。

你可以把公开页面内容提取成结构化数据，再直接进入分析、复盘、对比和素材沉淀流程，而不是停留在“导出一个文件”。
