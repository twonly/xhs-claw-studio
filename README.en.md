...
This repository keeps the packaged ZIP for convenience, so users can either download the whole project folder or download the ZIP and unzip it before installation.
...
├── analysis/     # dashboard and comparison views
├── library/      # material library
├── lib/          # shared modules
├── icons/        # extension icons
├── landing/      # landing page
├── docs/         # docs and trial guide
...
node --check analysis/analysis.js
...
- AI is BYOK
- packaging does not include your local browser-stored API key
- cloud sync is optional
- most core workflows work without AI

## License

No open-source license has been attached yet.

If you plan to make the repository public for reuse, add one before launch.
